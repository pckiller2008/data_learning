...
def schedulecost(sol):
	...
	for d in range(len(sol)/2):
		...
		if earlistdepart>getminutes(returnf[0]): earlistdepart = getminutes(returnf[0])
	...
	for d in range(len(sol)/2):
		...
		totalwait += getminutes(returnf[0]) - earlistdepart
	if latestarrival>earlistdepart : totalprice += 50
